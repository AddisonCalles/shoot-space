...
function body3(xoff, yoff, xmul, ymul) {
    const ctx = new Path2D();
...
function body2(xoff, yoff, xmul, ymul) {
    const ctx = new Path2D();
...
function guns1(xoff, yoff, xmul, ymul) {
    const ctx = new Path2D();
...
function guns2(xoff, yoff, xmul, ymul) {
    const ctx = new Path2D();
...
export const queenShipV1Drawing =  (color, element)=>([
